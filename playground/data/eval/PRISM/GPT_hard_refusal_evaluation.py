...
if args.mode== 'Original-LLaVA':
    input_file = "./answers/PRISM-hard-refusal-original-llava-v1.5-7b.jsonl"
    log_file = "./results/original-llava-hard_refusal_accuracy_log.txt"
    
else:
    input_file = "./answers/PRISM-hard-refusal-safe-llava-v1.5-7b.jsonl"
    log_file = "./results/safe-llava-hard_refusal_accuracy_log.txt"
